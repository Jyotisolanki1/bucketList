...
import { Grid, Stack, TextField, Typography, Button, CircularProgress, Select, MenuItem, FormControl, InputLabel } from '@mui/material';
...
const Profile = () => {
    ...
    console.log('sales_person', adminDetails);
    ...
    const onSubmit = async (values, { resetForm }) => {
        if (imageError.trim() !== '') {
            ...
            try {
                ...
                formData.append('sales_person', values?.sales_person?._id);
            ...
            <form onSubmit={formik.handleSubmit} id="validation-forms">
                {loading ? (
                    ...
                    <Grid container spacing={2} direction="column">
                        ...
                        <Grid item xs={12} sm={6}>
                            {adminDetails?.sales_person ? (
                                <TextField
                                    id="sales_person"
                                    name="sales_person"
                                    label={<FormattedMessage id="Sales Person" />}
                                    value={`${formik.values.sales_person?.firstname} ${formik.values.sales_person?.lastname}`}
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
