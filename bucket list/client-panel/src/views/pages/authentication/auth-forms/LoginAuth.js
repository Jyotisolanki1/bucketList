...
import { AdminLoginApi, ProfileApi } from '../../../../store/slices/adminAuth';
        ...
        AdminLoginApi(newData)
            .then((res) => {
                ...
                if (res?.success === true) {
                    ...
                    console.log(res?.data?.client?.profile_pic);
                    localStorage.setItem('clientProfile', res?.data?.client?.profile_pic);
