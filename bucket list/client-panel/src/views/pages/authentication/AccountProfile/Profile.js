...
const Profile = ({ UpdateProfileApi, AdminDetailApi }) => {
    ...
    const { adminDetails, adminRole, clientToken } = useSelector((state) => state.admin);
        ...
        UpdateProfileApi(formData)
            .then(async (res) => {
                if (res.succeeded === true) {
                    setSubmitting(false);
                    AdminDetailApi(clientToken, adminRole);
                    await dispatch(
                        openSnackbar({
                            open: true,
    ...
    const handleClick = () => {
        ...
        formik.setFieldTouched('profile_pic', false);
    ...
    const onChangeFile = (event) => {
        ...
        formik.setFieldTouched('profile_pic', true);
    ...
    const handleCountryChange = (event, newValue) => {
        formik.setFieldValue('selectedCountryCode', newValue);
    };
                            ...
                            <Grid container spacing={gridSpacing}>
                                ...
                                <Grid item md={4} xs={12}>
                                    <Autocomplete
                                        ...
                                        value={formik.values.selectedCountryCode}
                                        ...
                                        renderOption={(props, option) => (
                                            <Box component="li" {...props} key={option.label}>
                                                <img
                                                    ...
                                                    src={`https://flagcdn.com/w20/${option.code.toLowerCase()}.png`} // srcSet={`https://flagcdn.com/w40/${option.code.toLowerCase()}.png 2x`}
                                                    alt="flag-pic"
                                                />
