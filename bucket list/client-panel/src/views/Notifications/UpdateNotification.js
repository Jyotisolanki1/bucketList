...
import { UpdateNotificationsAPI, GetNotificationsAPI } from 'store/slices/notifications';
...
const UpdateNotification = ({ notificationId, notificationText, handleModalClose }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            const notification = { notification_id: notificationId, notification: values.notification };
            const response = await dispatch(UpdateNotificationsAPI(notification));
            handleModalClose();
