...
const App = ({ AdminDetailApi }) => {
    ...
    // const newRole = localStorage.getItem('clientToken');
    // const { clientToken, adminRole } = useSelector((state) => state.admin);
    // sx={{ '& > *': { borderBottom: 'unset' } }}
    // useEffect(() => {
    //     setAuthSession(newRole);
    //     AdminDetailApi(clientToken).then((res) => {
    //         localStorage.setItem('clientProfile', JSON.stringify(res.ResponseData));
