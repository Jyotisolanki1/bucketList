...
// import { SessionLogout } from 'store/slices/adminAuth';
import { dispatch } from 'store';
import { useSelector } from 'react-redux';

// ==============================|| PROFILE MENU ||============================== //

const ProfileSection = ({ SessionLogout }) => {
    ...
    const { name, profile } = useSelector((state) => state.admin);
    ...
    return (
        <>
            <Chip
                ...
                label={<IconSettings stroke={1.5} size="24px" color={theme.palette.secondary.dark} />}
                variant="outlined"
                ref={anchorRef}
                aria-controls={open ? 'menu-list-grow' : undefined}
                aria-haspopup="true"
