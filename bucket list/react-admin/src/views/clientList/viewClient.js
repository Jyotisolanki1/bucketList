...
import { ProfileApi, updateProfileApi, BusinessCategory, SalesPersons } from 'store/slices/client';
...
const Profile = () => {
    ...
    const validationSchema = yup.object().shape({
        ...
        company_information: yup
            ...
            .max(254, 'Compnay information must be at most 254 characters'),
        category: yup
            .string()
    ...
    const initialValues = {
        ...
        sales_person: adminDetails?.sales_person?._id,
        image: null
    };
        ...
        <MainCard
            title={
                <Grid container alignItems="center" justifyContent="space-between" spacing={2}>
                    <Grid item>
                        <Typography variant="h3">Client Profile</Typography>
                    </Grid>
                </Grid>
            }
        >
