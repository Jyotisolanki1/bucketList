...
import { sendBulkMailApi, getAllUser } from '../../../store/slices/mailAndnotification';
                            ...
                            <Grid container spacing={gridSpacing}>
                                ...
                                <Grid item xs={12}>
                                    <Grid container spacing={1} alignItems="center">
                                        ...
                                        <Grid item>
                                            <Button disabled={loading} variant="contained" sx={{ my: 3, ml: 1 }} type="submit" style={{backgroundColor:"#3C2F28"}}>
                                                {loading ? (
                                                    <>
